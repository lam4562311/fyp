#ifndef _ROS_ps4_bot_Navigation_h
#define _ROS_ps4_bot_Navigation_h
...
namespace ps4_bot
{
  ...
  class Navigation : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "ps4_bot/Navigation"; };
