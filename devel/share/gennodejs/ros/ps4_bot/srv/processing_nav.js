...
class processing_navRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new processing_navRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new processing_navRequest(null);
...
class processing_navResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('response')) {
        ...
        this.response = new std_msgs.msg.Empty();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = std_msgs.msg.Empty.serialize(obj.response, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new processing_navResponse(null);
    // Deserialize message field [response]
    data.response = std_msgs.msg.Empty.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new processing_navResponse(null);
    if (msg.response !== undefined) {
      resolved.response = std_msgs.msg.Empty.Resolve(msg.response)
    }
    else {
      resolved.response = new std_msgs.msg.Empty()
    }
...
module.exports = {
  Request: processing_navRequest,
  Response: processing_navResponse,
  md5sum() { return '6c2000b835c29a9b778713421830025f'; },
  datatype() { return 'ps4_bot/processing_nav'; }
};
