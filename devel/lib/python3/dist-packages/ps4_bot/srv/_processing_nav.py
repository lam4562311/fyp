...
"""autogenerated by genpy from ps4_bot/processing_navRequest.msg. Do not edit."""
import codecs
import sys
...
class processing_navRequest(genpy.Message):
  _md5sum = "7307218b869e7c7e3251c645c123d534"
  _type = "ps4_bot/processing_navRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(processing_navRequest, self).__init__(*args, **kwds)
...
def _get_struct_3d4q():
    ...
    return _struct_3d4q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ps4_bot/processing_navResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class processing_navResponse(genpy.Message):
  _md5sum = "f624545799d912fd57177cf7069e330d"
  _type = "ps4_bot/processing_navResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(processing_navResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.response is None:
        self.response = std_msgs.msg.Empty()
    else:
      self.response = std_msgs.msg.Empty()
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class processing_nav(object):
  _type          = 'ps4_bot/processing_nav'
  _md5sum = '6c2000b835c29a9b778713421830025f'
  _request_class  = processing_navRequest
  _response_class = processing_navResponse
