...
"""autogenerated by genpy from ps4_bot/navigationRequest.msg. Do not edit."""
import codecs
import sys
...
class navigationRequest(genpy.Message):
  ...
  _type = "ps4_bot/navigationRequest"
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ps4_bot/navigationResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class navigationResponse(genpy.Message):
  _md5sum = "e395a9670e57edfa54d085ef61bac472"
  _type = "ps4_bot/navigationResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.polylines is None:
        self.polylines = ps4_bot.msg.vertices()
    else:
      self.polylines = ps4_bot.msg.vertices()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.polylines.vertices)
      buff.write(_struct_I.pack(length))
      for val1 in self.polylines.vertices:
        _x = val1
        buff.write(_get_struct_3d().pack(_x.latitude, _x.longitude, _x.altitude))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.latitude, _x.longitude, _x.altitude,) = _get_struct_3d().unpack(str[start:end])
        self.polylines.vertices.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class navigation(object):
  ...
  _md5sum = '2898f1f22432733d25df2f4d710eb4f7'
